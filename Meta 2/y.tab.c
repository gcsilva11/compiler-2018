...
static const yytype_uint16 yyrline[] =
{
      ...
      78,    85,    94,    97,   106,   112,   124,   127,   133,   141,
     148,   152,   159,   162,   170,   176,   180,   186,   189,   192,
     195,   198,   204,   207,   214,   217,   221,   224,   228,   235,
     246,   254,   257,   262,   266,   273,   277,   293,   298,   304,
     309,   314,   319,   324,   329,   335,   340,   345,   350,   355,
     361,   366,   371,   376,   381,   387,   391,   395,   400,   403,
     408,   411,   414,   417,   420,   424,   428
};
#endif
...
static const char *const yytname[] =
{
  ...
  "TypeSpec", "Declarator", "Statement", "StatementAux", "Expr", YY_NULLPTR
};
#endif
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 44 "uccompiler.y" /* yacc.c:1646  */
    {
...
#line 85 "uccompiler.y" /* yacc.c:1646  */
    {
															...
															adicionar_filho((yyvsp[-2].ast),(yyvsp[-1].ast));
															adicionar_filho((yyvsp[-2].ast),(yyvsp[0].ast));
														}
...
#line 97 "uccompiler.y" /* yacc.c:1646  */
    {
															(yyval.ast) = cria_no("FuncBody","");
															if((yyvsp[-1].ast)!=NULL){
																adicionar_filho((yyvsp[-1].ast),(yyval.ast));
															}
														}
...
#line 106 "uccompiler.y" /* yacc.c:1646  */
    {
															if((yyvsp[0].ast)!=NULL){
																adicionar_irmao((yyvsp[0].ast),(yyvsp[-1].ast));
															}
...
#line 112 "uccompiler.y" /* yacc.c:1646  */
    {
															if((yyvsp[-1].ast) != NULL && (yyvsp[0].ast) != NULL){
																adicionar_irmao((yyvsp[0].ast), (yyvsp[-1].ast));
																(yyval.ast) = (yyvsp[-1].ast);
															}
															else if((yyvsp[-1].ast) != NULL && (yyvsp[0].ast) == NULL){
																(yyval.ast) = (yyvsp[-1].ast);
															}
															else{					
																(yyval.ast) = (yyvsp[0].ast);
...
#line 148 "uccompiler.y" /* yacc.c:1646  */
    {
															...
															adicionar_filho((yyvsp[0].ast),(yyval.ast));
														}
...
#line 152 "uccompiler.y" /* yacc.c:1646  */
    {
															adicionar_filho((yyvsp[0].ast),(yyvsp[-2].ast));
...
#line 235 "uccompiler.y" /* yacc.c:1646  */
    {
															(yyval.ast) = cria_no("If","");
															adicionar_filho((yyval.ast),(yyvsp[-4].ast));
															if((yyvsp[-2].ast) != NULL){
																adicionar_irmao((yyvsp[-4].ast),(yyvsp[-2].ast));
															}
															if((yyvsp[0].ast) != NULL){
																adicionar_irmao((yyvsp[-2].ast),(yyvsp[0].ast));
															}
...
#line 277 "uccompiler.y" /* yacc.c:1646  */
    {
															...
															if((yyvsp[0].ast) == NULL && (yyvsp[-1].ast) != NULL){
																(yyval.ast) = (yyvsp[-1].ast);
															}
															else{
...
#line 434 "uccompiler.y" /* yacc.c:1906  */
